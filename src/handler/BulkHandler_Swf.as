package handler
{
	...
	public class BulkHandler_Swf extends BulkHandler
	{
		protected var _loader:Loader;
		
		public function BulkHandler_Swf(bulkFile:IBulkFile, bulkLoadingInfo:BulkItemLoadingInfo)
		{
		...
		{
			loadingInfo.bytes = event.target.bytes;
